...
#define kChannelTol 1   //Total number of channel
...
Initialize flicker filter calculation parameters
    ...
    Input:  val -- Initial voltage peak value. e.g. if rms is 57.74V, then peak value is 57.74*1.414
*/
void IniFilterPar(float val)
{
    int i, j;
    float fi;
